...
s:^(\s*enable_recursive_icon_lookup\s+=).*:\1 false:; \
s:^(\s*icon_path\s+=).*:\1 /usr/share/icons/Papirus/16x16/actions/\:/usr/share/icons/Papirus/16x16/devices/\:/usr/share/icons/Papirus/24x24/panel/:; \
